const CardUser = ({
  ...
  return (
    <div
      id={`user_${id}`}
      className={`card_user border-1 border-[#9A3379] text-[#d9d9d9] w-[17rem] h-auto rounded-[5px] bg-[#1E1E1E90] cursor-pointer hover:border-[cyan] transition duration-100 ease-in-out `}
