    ...
    return (
      <article
        className="flex flex-col justify-between align-center
                                text-[#dedede] p-5 w-95 h-95 bg-[#1E1E1E]
                                border-1 border-[#9A3379] hover:border-[cyan] duration-600"
      >
        <h1 className="text-[30px] tracking-widest text-[#9A3379] font-semibold w-[80%] h-[30%] mt-5 flex items-center">
          {title}
        </h1>
        <div className="flex justify-between items-center">
          <p className="w-[60%] text-[#bbb] tracking-wide font-medium">
            {text}
          </p>
        ...
        <button
          ...
          id={`${idButton}_id`}
          className="h-[42px]  ml-auto border-1 px-5 py-2 border-[#9A3379] text-[#9A3379] rounded-md 
