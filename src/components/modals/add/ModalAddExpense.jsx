...
const ModalAddExpense = ({ isOpen, onClose, onSave }) => {
  ...
  const inputs = [
        ...
        formData.expenseCategory === "STOCK" ? (
          <div className="flex gap-1">
            ...
            <span
              ...
              onClick={() => navigate(ROUTERS.BAR_STOCK)}
            >
              aqui
            </span>
          </div>
    ...
    <Input
      ...
      subtitle={
        ...
        formData.quantity > 0
          ? "Valor da unidade : " +
            getBRCurrency(formData.amountSpend / formData.quantity)
          : null
      }
    />,
    <Input
  ...
  const buttons = [
    ...
    <ConfirmButton
      text="Confirmar"
      onClick={() => onSave(formData, productOptions)}
    />,
  ];
